...
import InflexRobot.modules.sql.userinfo_sql as sql
...
from InflexRobot import telethn as InflexTelethonClient
from InflexRobot.__main__ import STATS, TOKEN, USER_INFO
from InflexRobot.modules.disable import DisableAbleCommandHandler
from InflexRobot.modules.helper_funcs.chat_status import sudo_plus
from InflexRobot.modules.helper_funcs.extraction import extract_user
from InflexRobot.modules.sql.afk_sql import check_afk_status, is_afk
from InflexRobot.modules.sql.global_bans_sql import is_user_gbanned
from InflexRobot.modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/InflexAssociation/7"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/InflexAssociation/8"
                            ),
                        ],
                    ]
                ),
