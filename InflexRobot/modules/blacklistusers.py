...
import InflexRobot.modules.sql.blacklistusers_sql as sql
from InflexRobot import DEMONS, DEV_USERS, DRAGONS, OWNER_ID, TIGERS, WOLVES, dispatcher
from InflexRobot.modules.helper_funcs.chat_status import dev_plus
