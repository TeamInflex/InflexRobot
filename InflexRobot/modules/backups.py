...
# from InflexRobot.modules.sql import warns_sql as warnssql
import InflexRobot.modules.sql.blacklist_sql as blacklistsql

# from InflexRobot.modules.sql import cust_filters_sql as filtersql
# import InflexRobot.modules.sql.welcome_sql as welcsql
import InflexRobot.modules.sql.locks_sql as locksql
import InflexRobot.modules.sql.notes_sql as sql

# from InflexRobot.modules.rules import get_rules
import InflexRobot.modules.sql.rules_sql as rulessql
from InflexRobot import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from InflexRobot.__main__ import DATA_IMPORT
from InflexRobot.modules.connection import connected
from InflexRobot.modules.helper_funcs.alternate import typing_action
from InflexRobot.modules.helper_funcs.chat_status import user_admin
from InflexRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("InflexRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("InflexRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `InflexRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("InflexRobot{}.backup".format(chat_id))  # Cleaning file
