...
import InflexRobot.modules.sql.users_sql as sql
...
from InflexRobot.modules import ALL_MODULES
from InflexRobot.modules.helper_funcs.chat_status import is_user_admin
from InflexRobot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="❄ ᴀʙᴏᴜᴛ ❄", callback_data="Inflex_"),
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("InflexRobot.modules." + module_name)
...
@run_async
def Inflex_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "Inflex_":
        uptime = get_readable_time((time.time() - StartTime))
        query.message.edit_text(
            text=f"*ʜᴇʏ,*🥀\n  *ᴛʜɪs ɪs {BOT_NAME}*"
            ...
            "\n\n────────────────────"
            f"\n*➻ ᴜᴩᴛɪᴍᴇ »* {uptime}"
            f"\n*➻ ᴜᴘᴅᴀᴛᴇꜱ »* [ɪɴꜰʟᴇx ᴜᴘᴅᴀᴛᴇꜱ](https://t.me/InflexUpdates)"
            f"\n*➻ ꜱᴜᴘᴘᴏʀᴛ »* [ɪɴꜰʟᴇx ꜱᴜᴘᴘᴏʀᴛ](https://t.me/InflexSupport)"
            "\n────────────────────"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴩᴩᴏʀᴛ", callback_data="Inflex_support"
                        ),
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(text="◁", callback_data="Inflex_back"),
                    ],
                ]
            ),
        )
    elif query.data == "Inflex_support":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ",
                            url="https://github.com/TeamInflex",
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="◁", callback_data="Inflex_"),
                    ],
                ]
            ),
        )
    elif query.data == "Inflex_back":
        first_name = update.effective_user.first_name
        query.message.edit_text(
            PM_START_TEXT.format(escape_markdown(first_name), BOT_NAME),
            reply_markup=InlineKeyboardMarkup(buttons),
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/TeamInflex/InflexRobot)


{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://github.com/TeamInflex/InflexRobot/blob/master/LICENSE).
© 2022 - 2023 [@InflexSupport](https://t.me/{SUPPORT_CHAT}), ᴀʟʟ ʀɪɢʜᴛs ʀᴇsᴇʀᴠᴇᴅ.
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
┗•❅────✧❅✦❅✧────❅•┛""",
    ...
    about_callback_handler = CallbackQueryHandler(
        Inflex_about_callback, pattern=r"Inflex_"
    )
